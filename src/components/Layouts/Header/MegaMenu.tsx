...
export const MegaMenu = ({
  ...
  return (
    <div
      ...
      className={`absolute z-[500] w-full scale-100 transform border border-t-0 border-solid border-neutral-200 bg-violet-100 shadow-md transition-all duration-300 ease-in-out 
        `}
    >
      {isLoading ? (
